      ...
      <div class="row text-center">
        <div class="col-lg-8 mx-auto">
          <div class="hero-img mx-auto mb-3 position-relative">
            <img src="{{asset($hero_views->photo)}}" alt="img">
            <span class="shape shape-1"></span>
            <span class="shape shape-2"></span>
            <span class="shape shape-3"></span>
            <span class="shape shape-4"></span>
          </div>
          <p class="mb-3 fw-medium fs-4 text-primary">{{$hero_views->title}}</p>
          <h1 class="mb-4">{{$hero_views->skill_title}}</h1>
          <p class="mb-5">{{$hero_views->short_desc}}</p>
          <a href="#" class="btn btn-primary btn-lg">{{$hero_views->button}}</a>
        </div>
      </div>
    </div>
  ...
  <section class="brand-logo section pt-0">
    <div class="container">
      <div class="brand-logo-slider" data-aos="fade-up" data-aos-duration="1500">
        @foreach ($brand_views as $brand_info)
           <img class="brand-logo-img img-fluid" src="{{asset($brand_info->brand_photo)}}" alt="img">
        @endforeach
      </div>
    </div>
    </div>
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-md-6">
          <div class="me-4" data-aos="fade-right" data-aos-duration="1500">
            <h2>{{$global_views->global_title}}</h2>
          </div>
        </div>
        <div class=" col-md-6" data-aos="fade-left" data-aos-duration="1500">
          <p class="mb-0">{{$global_views->global_desc}}</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="services section">
    <div class="container">
      ...
      <div class="row g-4 justify-content-center">
        @foreach ($service_views as $service)
          ...
          <div class="card text-center  border-0 bg-white radius shadow px-3 py-5" data-aos="fade-right"
            ...
            <div class="card-body">
              ...
              <p class="card-text small">{{$service->desc}}</p>
              <a href="portfolio-single.html" class="text-primary card-link mb-0 small">{{$service->button}}<i
      ...
      <div class="row align-items-center justify-content-center bg-primary" data-aos="fade-up"
        ...
        <div class="col-md-7 order-1 order-md-0">
          <div class="testimonial-left-slider">
            @foreach ($testmonial as $testmonial_row )
              ...
              <div class="ms-lg-5 ms-md-4  mb-3">
                <div class="ms-md-4">
                  <p>{{$testmonial_row->desc}}</p>
                </div>
                <div class="d-flex ms-md-4   align-items-center justify-content-md-start justify-content-center">
                  <img class="img" src="{{asset($testmonial_row->photo_thum)}}" alt="img">
                  <div class="text ms-3">
                    <h5 class="mt-4 mb-1">{{$testmonial_row->title_name}}</h5>
                    <p>{{$testmonial_row->title_grate}}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="col-md-5 col-xl-4 order-0 order-md-1">
          <div class="testimonial-right-slider mb-md-0 mb-5">
            @foreach ($testmonial as $rows)
               <img class="img img-fluid" src="{{$rows->photo}}" alt="img">
            @endforeach
  ...
  <section class="projects section pt-0">
    <div class="container">
      ...
      <div class="row g-4 g-md-5 ">
        @foreach ($product_views as $pro_row)
          ...
          <div class="card rounded-0 border-0" data-aos="fade-up" data-aos-duration="1500">
            ...
            <div class="card-img-overlay">
              <div class="card-body">
                <a href="{{route('product.single',$pro_row->id)}}" class="h4 text-white">{{$pro_row->pro_title}}</a>
        ...
        <div class="col-12 mx-auto text-center">
          <a href="#" class="btn btn-outline-primary text-capitailize fw-medium py-2">view all</a>
        </div>
      </div>
    </div>
    </div>
